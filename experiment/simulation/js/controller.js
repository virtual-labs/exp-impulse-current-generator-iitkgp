...
//        V[i] = (((v * 2.5) * (Math.exp(-a * t[i]) - Math.exp(-b * t[i]))) / (RF * C1 * (b - a)));
        I[i] = ((V0 / 7 * w * e) * (Math.sin(w * t[i])) * (Math.exp((-c / 2 * e) * t[i])));
    ...
    var options = {
        title: 'I - T Curve' + '\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0' + 'V =' + ' ' + titleGraph1 + ' ' + 'kV' + '    \xa0\xa0\xa0      ' + 'Cg =' + ' ' + titleGraph2 + ' ' + '\xB5' + 'F' + '   \xa0\xa0\xa0    ' + 'Lf =' + ' ' + titleGraph3 + ' ' + '\xB5' + 'H' + '  \xa0\xa0\xa0     ' +   'Lt =' + ' ' + titleGraph6 + ' ' + '\xB5' + 'H' + '  \xa0\xa0\xa0'+       'Rf =' + ' ' + titleGraph4 + ' ' + '\u2126' + '   \xa0\xa0\xa0    ' + 'Rt =' + ' ' + titleGraph5 + ' ' + '\u2126',
